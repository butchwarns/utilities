...
constexpr int PHASE_FLIP_HEIGHT = 2 * LABEL_HEIGHT;

// Rotary sliders with label and textbox
constexpr int SLIDERS_HEIGHT = SLIDER_ROTARY_LABELED_HEIGHT;

constexpr int WIN_HEIGHT = HEADER_HEIGHT + FOOTER_HEIGHT + 3 * SPACER_HEIGHT + CHANNELS_HEIGHT + BASS_MONO_HEIGHT + 2 * PAD + SLIDERS_HEIGHT + PHASE_FLIP_HEIGHT;
